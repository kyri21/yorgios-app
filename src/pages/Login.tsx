...
const IPAD_EMAIL = 'ipad@yorgios.fr'
...
export default function Login() {
  ...
  async function handleLogin(e: React.FormEvent) {
    ...
    setLoading(true);
    try {
      const loginEmail = quickMode ? IPAD_EMAIL : email.trim();
      ...
      <div style={{
        ...
        {!quickMode && (
          ...
          >
            ...
            <div style={{ textAlign: 'left' }}>
              <div style={{ fontSize: 15, fontWeight: 700, color: 'var(--on-surface)' }}>iPad Corner</div>
              <div style={{ fontSize: 12, color: 'var(--on-surface-3)', marginTop: 2 }}>Accès tablette partagée</div>
            </div>
        ...
        {quickMode && (
          <div style={{
            ...
            <div style={{ flex: 1 }}>
              <div style={{ fontFamily: 'Manrope, sans-serif', fontSize: 14, fontWeight: 700, color: '#004275' }}>iPad Corner</div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, margin: '20px 0', width: '100%' }}>
          ...
          <span style={{ fontFamily: 'Manrope, sans-serif', fontSize: 12, color: 'var(--on-surface-3)' }}>Yorgios Restaurant</span>
          <div style={{ flex: 1, height: 1, background: 'var(--border-soft)' }} />
        </div>
      </div>
